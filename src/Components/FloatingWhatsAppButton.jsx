...
const FloatingWhatsAppButton = () => {
  ...
  return (
    <button
      ...
      className="fixed bottom-8 right-8 z-50 bg-[#25D366] hover:bg-[#20ba5a] text-white rounded-full p-4 shadow-lg flex items-center justify-center transition-all duration-300 hover:scale-110"
