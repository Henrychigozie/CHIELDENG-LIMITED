        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="fade-in space-y-6">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              At <strong className="text-[#0b0642]">CHIELDENG Cleaning Service</strong>, we aren't just a general maintenance company—we are specialized cleaning experts. Serving London and surrounding areas, we’ve built our reputation on the belief that a clean home is the foundation of a happy life.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
      ...
      <section className="py-24 max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 lg:order-2 fade-in space-y-8">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0b0642]">Why London Chooses CHIELDENG CLEANING SERVICE</h2>
