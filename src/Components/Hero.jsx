    ...
    <div className="bg-white font-sans text-slate-800 h-screen w-full mt-16">
      ...
      <main className="relative overflow-hidden bg-slate-100">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-16 md:py-24 min-h-[70vh] md:min-h-[80vh] lg:min-h-screen flex items-center">
          <div className="w-full md:w-1/2 space-y-6 md:space-y-8 text-center md:text-left">
            ...
            Starting from{" "}
              <span className="text-[#56ab2f] text-4xl sm:text-5xl font-bold">£25 - £30</span>{" "}
              Per Room
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-12 text-center">
            <div className="fade-in space-y-6 group">
              <div className="w-24 h-24 bg-slate-50 rounded-full flex items-center justify-center mx-auto transition-transform group-hover:scale-110 duration-300 shadow-sm border border-slate-100">
                <img src="https://cdn-icons-png.flaticon.com/512/3652/3652191.png" alt="Customise" className="w-12 h-12 opacity-80" />
              </div>
            ...
            <div className="fade-in space-y-6 group">
              <div className="w-24 h-24 bg-slate-50 rounded-full flex items-center justify-center mx-auto transition-transform group-hover:scale-110 duration-300 shadow-sm border border-slate-100">
                <img src="https://cdn-icons-png.flaticon.com/512/2329/2329013.png" alt="Manage" className="w-12 h-12 opacity-80" />
              </div>
              <h3 className="text-xl font-bold text-[#0b0642]">
                <span className="text-slate-300 mr-2 text-2xl">2.</span> Easily manage online
              </h3>
              <p className="text-gray-600 leading-relaxed px-4">
            ...
            <div className="fade-in space-y-6 group">
              <div className="w-24 h-24 bg-slate-50 rounded-full flex items-center justify-center mx-auto transition-transform group-hover:scale-110 duration-300 shadow-sm border border-slate-100">
                <img src="https://cdn-icons-png.flaticon.com/512/3048/3048122.png" alt="Enjoy" className="w-12 h-12 opacity-80" />
              </div>
              <h3 className="text-xl font-bold text-[#0b0642]">
                <span className="text-slate-300 mr-2 text-2xl">3.</span> Enjoy your time!
              </h3>
              <p className="text-gray-600 leading-relaxed px-4">
          ...
          <div className="mt-16 text-center fade-in">
            <Link to="/service" className="inline-block bg-[#e91e63] hover:bg-[#d81557] text-white px-10 py-4 rounded-lg font-bold text-lg shadow-lg transition-all active:scale-95">
              Book a service
            </Link>
      ...
      <section className="relative py-24 overflow-hidden min-h-[90vh] flex items-center">
        <div className="absolute inset-0 z-0 bg-slate-900">
          <img src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&q=80&w=2000" alt="Luxury clean interior" className="w-full h-full object-cover" />
